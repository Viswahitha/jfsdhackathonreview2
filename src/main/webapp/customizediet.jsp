...
<div class="container">
    ...
    <div class="diet-cards-container" id="dietCardContainer">
        ...
        <div class="card">
            ...
            <p class="card-text">Explore plant-based options for a healthy lifestyle.</p>
            <a href="#" class="btn btn-primary">View Plan</a>
        </div>
        <div class="card">
            <img src="/images/vegandiet.jpg" alt="Keto Plan">
            <h5 class="card-title">Keto</h5>
            <p class="card-text">Explore low-carb options for a healthy lifestyle.</p>
            <a href="#" class="btn btn-primary">View Plan</a>
        </div>
        <div class="card">
            <img src="/images/vegandiet.jpg" alt="Plateo Plan">
            <h5 class="card-title">Plateo</h5>
            <p class="card-text">Explore plant-based options for a healthy lifestyle.</p>
            <a href="#" class="btn btn-primary">View Plan</a>
        </div>
    </div>
